...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1558876637);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1558276810);
user_pref("browser.laterrun.bookkeeping.sessionCount", 2);
user_pref("browser.laterrun.enabled", true);
user_pref("browser.migration.version", 66);
user_pref("browser.newtabpage.activity-stream.impressionId", "{a7870cf1-1528-4036-8305-119abe9fa9c7}");
user_pref("browser.newtabpage.activity-stream.migrationExpired", true);
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1558234800);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1558876620834");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1558880220834");
...
user_pref("browser.slowStartup.averageTime", 10652);
...
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1558876624619");
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"cbafb5f8-b217-462b-a7af-99ffffa0e24b\"}");
...
user_pref("sanity-test.driver-version", "10.18.14.5057");
user_pref("sanity-test.running", false);
user_pref("sanity-test.version", "20180516032328");
user_pref("security.sandbox.content.tempDirSuffix", "{3140f690-38a5-4eeb-bed3-16a82d2052e3}");
user_pref("signon.importedFromSqlite", true);
user_pref("toolkit.startup.last_success", 1558876603);
user_pref("toolkit.telemetry.cachedClientID", "90d399c8-2a97-4dd1-9f14-cfda7a28cc7d");
